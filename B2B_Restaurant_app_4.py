...
class Customer:
    ...
    def create_customer_data(self):
        ...
        customer_master_list.append(user_data)
    ...
    def create_order_data(self):
        ...
        for i in user_login:
            ...
            if self.customerMobile == i[3]:
                ...
                self.list_order = self.order_id_generate(), self.date, amount, self.orderType
                user_login.append(self.list_order)
...
#
# def sign_in(customer_mobile, customer_password):
#
#     customer_mobile = input('Enter your username (mobile): ')
#     customer_password = input('Enter your password: ')
#
#     for customer_mobile in user_login:
#
#         if customer_mobile ==
